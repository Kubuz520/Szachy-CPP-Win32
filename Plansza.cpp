...
Plansza::Plansza() {
	...
	plansza[0][1] = new Pionek(0, 1, false, 0);
	plansza[1][1] = new Pionek(1, 1, false, 0);
	plansza[2][1] = new Pionek(2, 1, false, 0);
	plansza[3][1] = new Pionek(3, 1, false, 0);
	plansza[4][1] = new Pionek(4, 1, false, 0);
	plansza[5][1] = new Pionek(5, 1, false, 0);
	plansza[6][1] = new Pionek(6, 1, false, 0);
	plansza[7][1] = new Pionek(7, 1, false, 0);

	for (int i = 2; i <= 5; i++)
		for (int j = 0; j < 8; j++)
			plansza[j][i] = new PustePole(j, i);

	plansza[0][6] = new Pionek(0, 6, true, 0);
	plansza[1][6] = new Pionek(1, 6, true, 0);
	plansza[2][6] = new Pionek(2, 6, true, 0);
	plansza[3][6] = new Pionek(3, 6, true, 0);
	plansza[4][6] = new Pionek(4, 6, true, 0);
	plansza[5][6] = new Pionek(5, 6, true, 0);
	plansza[6][6] = new Pionek(6, 6, true, 0);
	plansza[7][6] = new Pionek(7, 6, true, 0);
